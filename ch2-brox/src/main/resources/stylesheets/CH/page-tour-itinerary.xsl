      ...
      <fo:static-content flow-name="header-first-CH">
        <fo:block-container height="19mm" overflow="hidden"
          ...
          <fo:block font-family="FuturaStd-ExtraBold" font-size="34pt" font-weight="bold" 
            border-bottom-style="solid" margin-bottom="7mm" span="all">
            ITINERARY
          </fo:block>
      ...
      <fo:static-content flow-name="header-rest-CH">
         <fo:block-container height="19mm" overflow="hidden"
          ...
          <fo:block font-family="FuturaStd-ExtraBold" font-size="34pt" font-weight="bold" 
            border-bottom-style="solid" margin-bottom="7mm" span="all">
            ITINERARY 
            <fo:inline font-family="FuturaStd-Bold" font-size="20">(continued)</fo:inline>
          </fo:block>
...
<!--    <fo:block keep-together.within-page="always">-->
      ...
      <xsl:for-each
		select="ti:ItinerarySegment[position() &lt; 5]">
...
<!--    </fo:block>  -->
  ...
  <xsl:template name="ItinerarySegment-CH">
    ...
    <fo:block margin-left="0mm" margin-right="1mm"
      margin-bottom="5mm" font-size="9pt" padding-left="0mm"
