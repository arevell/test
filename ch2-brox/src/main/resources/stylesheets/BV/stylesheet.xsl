<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:include href="stylesheets/BV/page-frontcover.xsl" />
	<xsl:include href="stylesheets/BV/page-frontcover-TT.xsl" />
	<xsl:include href="stylesheets/BV/page-contents.xsl" />
	<xsl:include href="stylesheets/BV/page-intro1.xsl" />
	<xsl:include href="stylesheets/BV/page-intro2.xsl" />
	<xsl:include href="stylesheets/BV/page-offers.xsl" />
	<xsl:include href="stylesheets/BV/page-tour.xsl" />
	<xsl:include href="stylesheets/BV/page-terms.xsl" />
	<xsl:include href="stylesheets/BV/text.xsl" />
	<xsl:include href="stylesheets/BV/attribute-sets.xsl" />
	<xsl:include href="stylesheets/BV/layout.xsl" />
	<xsl:include href="stylesheets/BV/format.xsl" />
