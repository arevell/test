<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="layout-regions-cover">
		...
		<fo:region-before extent="5mm" background-color="#002664" />
		<fo:region-after extent="5mm" background-color="#002664"
			region-name="footer" />
		<fo:region-start extent="5mm" background-color="#002664" />
		<fo:region-end extent="5mm" background-color="#002664" />
	</xsl:template>
