...
@Service
public class FileCollectV3WeaveService {
    private static Logger logger = LoggerFactory.getLogger(FileCollectV3WeaveService.class);
    ...
    public void download(SellingCompany selected) throws FileNotFoundException {
        try {
            byte[] data = fileCollectService.getLatestVersion(selected.getCode(), FileCollectVersion.V3);
