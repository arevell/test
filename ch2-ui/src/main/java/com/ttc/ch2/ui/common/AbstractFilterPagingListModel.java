...
public abstract class AbstractFilterPagingListModel<T> extends AbstractListModel<T> implements Sortable<T>
{
	...
	public AbstractFilterPagingListModel(int activePage, int pageSize,T filter) {
		super();
		this.filter=filter;
	...
	public AbstractFilterPagingListModel<T> loadData(QueryCondition condition){		
		if(condition==null)
	...
	public AbstractFilterPagingListModel<T> loadData()
	{
...
//		addListDataListener(new ListDataEvent(this, ListDataEvent.CONTENTS_CHANGED, -1, -1));
