...
public class SchedulerValidator extends AbstractValidator{

	@Override
	public void validate(ValidationContext ctx) {
			Map<String,Property> beanProps = ctx.getProperties(ctx.getProperty().getBase());
			
			validateDate(ctx, (String)beanProps.get("chgTime").getValue());
		
	}

	
	private void validateDate(ValidationContext ctx, String date) {
