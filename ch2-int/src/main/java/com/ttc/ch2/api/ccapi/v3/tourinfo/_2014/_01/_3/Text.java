...
public class Text {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "br", namespace = "http://www.ttc.com/ch2/api/ccapi/v3/TourInfo/2014/01/3.0", type = Br.class, required = false),
        @XmlElementRef(name = "ul", namespace = "http://www.ttc.com/ch2/api/ccapi/v3/TourInfo/2014/01/3.0", type = JAXBElement.class, required = false)
    })
    @XmlMixed
