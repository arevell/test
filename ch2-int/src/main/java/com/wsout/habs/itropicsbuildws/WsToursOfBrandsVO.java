...
/**
 * <p>Java class for wsToursOfBrandsVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="wsToursOfBrandsVO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Tour" type="{http://com.tropics.webservice.iTropics.facade/ITropicsBuildWS.xsd}wsTourOfBrandVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "wsToursOfBrandsVO", propOrder = {
    "errorMessage",
    "errorMessagesArray",
    "successful",
    "tour"
})
public class WsToursOfBrandsVO {
    ...
    protected List<WsTourOfBrandVO> tour;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WsTourOfBrandVO }
     * 
     * 
     */
    public List<WsTourOfBrandVO> getTour() {
        if (tour == null) {
            tour = new ArrayList<WsTourOfBrandVO>();
        }
        return this.tour;
    }
