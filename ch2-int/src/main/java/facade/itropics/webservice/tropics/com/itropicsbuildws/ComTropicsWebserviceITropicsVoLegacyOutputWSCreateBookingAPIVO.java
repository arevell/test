...
/**
 * <p>Java class for com_tropics_webservice_iTropics_vo_legacy_output_WSCreateBookingAPIVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="com_tropics_webservice_iTropics_vo_legacy_output_WSCreateBookingAPIVO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="wsErrorMessageVO" type="{http://com.tropics.webservice.iTropics.facade/ITropicsBuildWS.xsd}com_tropics_webservice_iTropics_vo_legacy_WSErrorMessageVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "com_tropics_webservice_iTropics_vo_legacy_output_WSCreateBookingAPIVO", propOrder = {
    "errorMessage",
    "errorMessagesArray",
    "productNotes",
    "successful",
...
public class ComTropicsWebserviceITropicsVoLegacyOutputWSCreateBookingAPIVO {
    ...
    @XmlElement(nillable = true)
    protected List<ComTropicsWebserviceITropicsVoLegacyWSErrorMessageVO> wsErrorMessageVO;
    ...
    /**
     * Gets the value of the wsErrorMessageVO property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsErrorMessageVO property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsErrorMessageVO().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ComTropicsWebserviceITropicsVoLegacyWSErrorMessageVO }
     * 
     * 
     */
    public List<ComTropicsWebserviceITropicsVoLegacyWSErrorMessageVO> getWsErrorMessageVO() {
        if (wsErrorMessageVO == null) {
            wsErrorMessageVO = new ArrayList<ComTropicsWebserviceITropicsVoLegacyWSErrorMessageVO>();
        }
        return this.wsErrorMessageVO;
    }
