...
/**
 * <p>Java class for com_tropics_webservice_iTropics_vo_legacy_output_WSApplyEPDAPIVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="com_tropics_webservice_iTropics_vo_legacy_output_WSApplyEPDAPIVO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="wsConfirmBkgTropicsMessage" type="{http://com.tropics.webservice.iTropics.facade/ITropicsBuildWS.xsd}com_tropics_webservice_iTropics_vo_legacy_WSTropicsMessage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "com_tropics_webservice_iTropics_vo_legacy_output_WSApplyEPDAPIVO", propOrder = {
    "errorMessage",
    "errorMessagesArray",
    "successful",
    "wsApplyEpdTropicsMessage",
    "wsBookingSummaryVO",
    "wsConfirmBkgTropicsMessage"
})
public class ComTropicsWebserviceITropicsVoLegacyOutputWSApplyEPDAPIVO {
    ...
    @XmlElement(nillable = true)
    protected List<ComTropicsWebserviceITropicsVoLegacyWSTropicsMessage> wsConfirmBkgTropicsMessage;
    ...
    /**
     * Gets the value of the wsConfirmBkgTropicsMessage property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsConfirmBkgTropicsMessage property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsConfirmBkgTropicsMessage().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ComTropicsWebserviceITropicsVoLegacyWSTropicsMessage> getWsConfirmBkgTropicsMessage() {
        if (wsConfirmBkgTropicsMessage == null) {
            wsConfirmBkgTropicsMessage = new ArrayList<ComTropicsWebserviceITropicsVoLegacyWSTropicsMessage>();
        }
        return this.wsConfirmBkgTropicsMessage;
    }
