...
/**
 * <p>Java class for wsTourSummariesVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="wsTourSummariesVO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="tours" type="{http://com.tropics.webservice.iTropics.facade/ITropicsBuildWS.xsd}wsTourSummaryVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "wsTourSummariesVO", propOrder = {
    "errorMessage",
    "errorMessagesArray",
    "successful",
    "tours"
})
public class WsTourSummariesVO {
    ...
    @XmlElement(nillable = true)
    protected List<WsTourSummaryVO> tours;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WsTourSummaryVO }
     * 
     * 
     */
    public List<WsTourSummaryVO> getTours() {
        if (tours == null) {
            tours = new ArrayList<WsTourSummaryVO>();
        }
        return this.tours;
    }
