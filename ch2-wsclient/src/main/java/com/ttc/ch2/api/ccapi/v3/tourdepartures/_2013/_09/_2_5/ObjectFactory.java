 ...
 * generated in the com.ttc.ch2.api.ccapi.v3.tourdepartures._2013._09._2_5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _TourDepartures_QNAME = new QName("http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", "TourDepartures");
    private final static QName _NotesBr_QNAME = new QName("http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", "br");
    private final static QName _NotesText_QNAME = new QName("http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", "text");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ttc.ch2.api.ccapi.v3.tourdepartures._2013._09._2_5
     * 
     */
    ...
    /**
     * Create an instance of {@link TourDeparturesType }
     * 
     */
    public TourDeparturesType createTourDeparturesType() {
        return new TourDeparturesType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TourDeparturesType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", name = "TourDepartures")
    public JAXBElement<TourDeparturesType> createTourDepartures(TourDeparturesType value) {
        return new JAXBElement<TourDeparturesType>(_TourDepartures_QNAME, TourDeparturesType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Notes.Br }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", name = "br", scope = Notes.class)
    public JAXBElement<Notes.Br> createNotesBr(Notes.Br value) {
        return new JAXBElement<Notes.Br>(_NotesBr_QNAME, Notes.Br.class, Notes.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ttc.com/ch2/api/ccapi/v3/TourDepartures/2013/09/2.5.4", name = "text", scope = Notes.class)
    public JAXBElement<String> createNotesText(String value) {
        return new JAXBElement<String>(_NotesText_QNAME, String.class, Notes.class, value);
    }
