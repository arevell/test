package com.ttc.ch2.cucumber.ccapisecurity.gettourdetailsfull;
...
public class GetTourDetailsFullTest {
	...
	{		
		...
		try
		{
			...
			{
				Function f =(Function) s.createQuery("from Function where name='" +FunctionType.GET_TOUR_DETAILS_FULL.getSimpleName()+ "'").uniqueResult();
				SellingCompany sc =(SellingCompany) s.createQuery("from SellingCompany where code='CHCANS'").uniqueResult();
