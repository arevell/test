package com.ttc.ch2.ch2_test_load.cucumber.v1.searchtours;
...
import com.ttc.ch2.ch2_test_load.cucumber.v1.SearchToursTest;
...
public class SearchTours {
	private static final Logger logger = LoggerFactory.getLogger(SearchTours.class);
	...
	public void execute_search_tours_load_test() {
		...
		final SearchToursTest searchToursTest = new SearchToursTest(sellingCompanyCode); 
		TestLoad test = new TestLoad() {
			public void executeLoad() {
				searchToursTest.testCcapiV1SearchTours();
			}
		};
