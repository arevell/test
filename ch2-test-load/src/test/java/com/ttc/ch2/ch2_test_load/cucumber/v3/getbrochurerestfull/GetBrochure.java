package com.ttc.ch2.ch2_test_load.cucumber.v3.getbrochurerestfull;
...
import com.ttc.ch2.ch2_test_load.cucumber.v3.GetBrochureRestTest;
...
public class GetBrochure {
	...
	public void execute_search_tours_load_test() throws IOException {
		...
		final GetBrochureRestTest getBrochureTest = new GetBrochureRestTest(brandCode, sellingCompanyCode, tourCode); 
