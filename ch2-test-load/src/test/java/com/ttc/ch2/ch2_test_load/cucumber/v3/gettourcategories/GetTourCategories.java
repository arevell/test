...
import com.ttc.ch2.ch2_test_load.cucumber.v3.GetTourCategoriesTest;
...
public class GetTourCategories {
	private static final Logger logger = LoggerFactory.getLogger(GetTourCategories.class);
	...
	public void obtain_current_data_from_db() throws IOException, ClassNotFoundException, SQLException{
		...
		String sql = "select sc.code as sccode" +
	...
	public void execute_search_tours_load_test() {
		...
		final GetTourCategoriesTest getTourCategoriesTest = new GetTourCategoriesTest(sellingCompanyCode); 
		TestLoad test = new TestLoad() {
			public void executeLoad() {
				getTourCategoriesTest.testCcapiV3GetTourCategories();
			}
		};
