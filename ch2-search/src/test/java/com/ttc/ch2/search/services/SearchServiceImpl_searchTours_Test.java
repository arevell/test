...
public class SearchServiceImpl_searchTours_Test extends MessageTest {

    private static Logger logger = LoggerFactory.getLogger(SearchServiceImpl_searchTours_Test.class);
    ...
    public void test_validation_null_request() throws Throwable {
        ...
        Collection<Message> messages = service.validate((SearchToursRequest)null);
    ...
    public void test_validation_request() throws Throwable {
        ...
        SearchToursRequest request = new SearchToursRequest();
    ...
    public void test_request_null() throws Throwable {
        ...
        when(service.searchTours(any(SearchToursRequest.class))).thenCallRealMethod();
        
        SearchToursResponse response = service.searchTours((SearchToursRequest)null);
    ...
    public void test_request() throws Throwable {
        ...
        SearchToursRequest request = mock(SearchToursRequest.class);
        doThrow(new RuntimeException("test_request()")).doNothing().when(request).setPreferedRoomType(any(String.class));
        
        SearchToursResponse response = service.searchTours(request);
